...
const Timeline: NextComponentType<NextPageContext, {}, Props> = ({ data }) => {
    return (
                    ...
                    return (
                        <li className="mb-10 ml-6" key={`detail_${index}`}>
                            ...
                            {longText && (
                                <p
                                    id="long_text"
                                    className="ml-2 mb-4 max-w-md overflow-hidden text-ellipsis whitespace-nowrap text-base font-normal text-gray-400"
                                >
                                    {longText}
                                </p>
                            )}
